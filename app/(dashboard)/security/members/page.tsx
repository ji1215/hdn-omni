          ...
          <div className="card h-full">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg">
              {departmentsLoading ? (
                ...
                <div className="space-y-2 max-h-[calc(100vh-24rem)] overflow-y-auto overflow-x-hidden pr-1">
                  {/* 전체 사용자 옵션 */}
                  <div
                    onClick={() => {
                      setSelectedDepartmentId(null);
                  ...
                  >
                    <div className="flex items-center gap-1 p-2 overflow-hidden">
                      ...
                      <div className="flex items-center gap-0.5 px-1.5 py-0.5 bg-gray-100 dark:bg-gray-700 rounded-full flex-shrink-0 ml-1">
